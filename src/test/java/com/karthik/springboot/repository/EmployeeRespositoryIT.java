...
public class EmployeeRespositoryIT {
...
//                .build();
    ...
    // unit test to update employee operation
...
//                .build();
        ...
        savedEmployee.setFirstName("hy");
        Employee updatedEmployee =  employeeRepository.save(savedEmployee);

        // then 
        assertThat(updatedEmployee.getEmail()).isEqualTo("seetha@gmail.com");
        assertThat(updatedEmployee.getFirstName()).isEqualTo("hy");
    }
...
//                .build();
    ...
    // unit test to custom query using JPQL & Named params
